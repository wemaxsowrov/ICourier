                            ...
                            <form action="{{route('merchant.payment.mobile.update')}}"  method="POST" enctype="multipart/form-data" id="basicform"  >
                                ...
                                @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="mobile_no" type="number" name="mobile_no" data-parsley-trigger="change" placeholder="{{ __('placeholder.Enter_mobile_number') }}" autocomplete="off" class="form-control" value="{{isset( $paymentInfo)?  $paymentInfo->mobile_no:old('mobile_no')}}" require>
                                        @error('mobile_no')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                        @enderror
                                    </div>
