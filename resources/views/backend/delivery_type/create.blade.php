...
@section('title','Delivery Type | Add')
@section('title')
    {{ __('levels.delivery_type') }} {{ __('levels.add') }}
@endsection
@section('maincontent')
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="title" type="text" name="title" data-parsley-trigger="change" placeholder="Enter Title" autocomplete="off" class="form-control" value="{{old('title')}}" require>
                                    @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="position" type="number" name="position" data-parsley-trigger="change" placeholder="Enter Position" autocomplete="off" class="form-control" value="{{old('position')}}" require>
                                    @error('position')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                </div>
