                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#"
                                        class="breadcrumb-link active">{{ __('mobileBank.add_mobile_bank') }}</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">{{ __('mobileBank.add_mobile_bank') }}</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('mobile-bank.store') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="name">{{ __('mobileBank.name') }}</label>
                                <input type="text" name="name" id="name" class="form-control" placeholder="{{ __('mobileBank.name') }}" value="{{ old('name') }}" required>
                                @error('name')
