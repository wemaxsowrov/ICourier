        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('fraud.store')}}"  method="POST" enctype="multipart/form-data" id="basicform">
                        @csrf
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for="phone">{{ __('levels.phone') }}</label> <span class="text-danger">*</span>
                                    <input id="phone" type="text" name="phone" data-parsley-trigger="change" placeholder="{{__( 'placeholder.Enter_phone')}}"  autocomplete="off" class="form-control @error('phone') is-invalid @enderror" value="{{old('phone')}}" require>
                                    @error('phone')
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="tracking_id" type="text" name="tracking_id" data-parsley-trigger="change" placeholder="{{ __('placeholder.Enter_tracking_id') }}" autocomplete="off" class="form-control @error('tracking_id') is-invalid @enderror" value="{{old('tracking_id')}}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
