                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input id="phone" type="text" name="phone" data-parsley-trigger="change" placeholder="{{ __('merchantPlaceholder.phone') }}" autocomplete="off" class="form-control @error('phone') is-invalid @enderror" value="{{old('phone',$fraud->phone)}}" require>
                                    @error('phone')
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" name="name" data-parsley-trigger="change" placeholder="{{ __('merchantPlaceholder.name') }}" autocomplete="off" class="form-control @error('name') is-invalid @enderror" value="{{old('name',$fraud->name)}}" require>
                                    @error('name')
                                    <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input id="tracking_id" type="text" name="tracking_id" placeholder="{{ __('merchantPlaceholder.tracking_id') }}" autocomplete="off" class="form-control @error('tracking_id') is-invalid @enderror" value="{{old('tracking_id',$fraud->tracking_id)}}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
