                    ...
                    <div class="row pl-4 pr-4 pt-4 merchantParcelPage">
                        ...
                        <div class="col-3 ">
                            <div class="d-flex justify-content-end  mt-0 parcel-create-import-btn-start">
                                ...
                                <a href="{{ route('merchant-panel.parcel.create') }}" class="btn btn-primary btn-sm mr-2"
                                    ...
                                    @foreach ($parcels as $parcel)
                                        <tr>
                                            ...
                                            <td class="merchantpayment">
                                                ...
                                                <div class="modal fade" id="noteModal{{ $parcel->id }}" tabindex="-1"
                                                    role="dialog" aria-labelledby="noteModalLabel{{ $parcel->id }}"
                                                    aria-hidden="true">
