...
@section('title')
    {{ __('levels.paystack_payout_details') }}
@endsection
@section('cardcontent')
    <div class="row">
        <div class="col-md-12 col-md-offset-3  ">
            <div class="card">
                <div class=" card-body panel panel-default credit-card-box">
                    <p class="h3">{{ __('levels.paystack_payout_details') }}</p>
                    <div class="panel-body">
                        <div class="col-md-6">
                            <form  action="{{route('online.payment.paystack.initialize.payment')}}" method="get" >
                                @csrf
                                ...
                                <div class="form-group d-flex">
                                    <input type="number" name="amount" id="amount" class="form-control w-unset"  />
