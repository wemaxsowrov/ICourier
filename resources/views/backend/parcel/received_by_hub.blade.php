<div class="modal fade" id="parcelstatus{{ \App\Enums\ParcelStatus::RECEIVED_BY_HUB }}"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="data-modal">
            ...
            <form action="{{ route('parcel.received-by.hub',['page'=>$request->page,'filter'=>$request->filter? $request->filter:'']) }}" method="post">
                @csrf
