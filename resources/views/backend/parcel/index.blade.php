                            ...
                            <div class="col-12 col-xl-6 mt-2 mt-lg-2 mt-xl-0">
                                <div class="text-right d-flex justify-content-end parcel-index-bulk">
                                    ...
                                    @if ($request->parcel_status == \App\Enums\ParcelStatus::DELIVERY_MAN_ASSIGN)
                                        <a href="{{ route('parcel.parcel-bulkassign-print', $request->all()) }}"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($parcels as $parcel)
                                        <tr>
                                            ...
                                            <td> {{ __('levels.track_id') }}: <span
                                                    class="active">{{ $parcel->tracking_id }}</td>
                                            ...
                                            <td class="merchantpayment">
                                                <div class="w150">
                                                    <div class="d-flex">
                                                        ...
                                                        @php
                                                            $words = explode(' ', $parcel->note ?? '');
                                                            $shortNote = implode(' ', array_slice($words, 0, 4)); // first 4 words
                                                        @endphp
                                                        ...
                                                        <p>
                                                            ...
                                                            @if (count($words) > 4)
                                                                ... <button type="button" class="btn btn-link p-0 m-0"
                                                                    data-toggle="modal"
                                                                    data-target="#noteModal{{ $parcel->id }}">
                                                                    See more
                                                                </button>
                                                            @endif
                                                        </p>
                                                ...
                                                <div class="modal fade" id="noteModal{{ $parcel->id }}"
                                                    tabindex="-1" role="dialog"
                                                    aria-labelledby="noteModalLabel{{ $parcel->id }}"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="noteModalLabel{{ $parcel->id }}">Parcel Notes
                                                                </h5>
