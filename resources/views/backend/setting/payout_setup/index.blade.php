        ...
        <div class="col-lg-6  col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    @if(hasPermission('payout_setup_settings_update'))
                    <form action="{{route('payout.setup.settings.update',\App\Enums\PayoutSetup::PAYSTACK)}}"  method="POST" enctype="multipart/form-data" id="basicform">
                        @method('PUT')
                        @csrf
                    @endif
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group">
                                    ...
                                    <input id="paystack_secret_key" type="text" name="paystack_secret_key" data-parsley-trigger="change" placeholder="{{ __('levels.paystack_secret_key') }}" autocomplete="off" class="form-control @error('paystack_secret_key') is-invalid @enderror" value="{{ old('paystack_secret_key', globalSettings('paystack_secret_key')) }}" require >
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="paystack_callback_url" type="text" name="paystack_callback_url" data-parsley-trigger="change" placeholder="{{ __('levels.paystack_callback_url') }}" autocomplete="off" class="form-control @error('paystack_callback_url') is-invalid @enderror" value="{{ old('paystack_callback_url', globalSettings('paystack_callback_url')) }}" require >
