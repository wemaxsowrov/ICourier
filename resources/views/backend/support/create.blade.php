                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('support.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="service" class="form-control @error('service') is-invalid @enderror">
                                            ...
                                            @foreach (trans('SalaryService') as $key => $value)
                                                <option
                                                    value="{{ $key }}"{{ old('service') == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="priority">{{ __('support.priority') }}</label> <span
                                            class="text-danger">*</span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control p-1 @error('department_id') is-invalid @enderror "
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap user-search">
                                    <textarea class="form-control" name="description" rows="7" id="descriptions"
                                        placeholder="{{ __('placeholder.Enter_description') }}" value="{{ old('description') }}"></textarea>
                                </div>
                            </div>
                            <div class="form-group  ">
