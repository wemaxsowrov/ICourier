    ...
    <div class="container-fluid  dashboard-content">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href=""
                                        class="breadcrumb-link">{{ @$page->title }}</a></li>
                                <li class="breadcrumb-item"><a href=""
        ...
        <div class="row">
            <div class="  col-sm-12 col-12">
                <div class="card">
                    <div class="card-body">
                        <h2 class="pageheader-title">{{ @$page->title }} {{ __('levels.edit') }}</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="title" type="text" name="title" data-parsley-trigger="change"
                                        ...
                                        value="{{ old('title', @$page->title) }}" require>
                                    @error('title')
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control  @error('description') is-invalid @enderror" name="description" id="summernote"
                                        rows="12">{{ old('description', @$page->description) }}</textarea>
                                    @error('description')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                </div>
